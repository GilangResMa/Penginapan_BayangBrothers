            ...
            <div class="form-container">
                <form method="POST" action="{{ route('admin.rooms.update', $room->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-input form-textarea" required>{{ old('description', $room->description) }}</textarea>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                        <div class="form-group">
                            ...
                            <input type="number" id="price_weekday" name="price_weekday" class="form-input" 
                                   value="{{ old('price_weekday', $room->price_weekday) }}" min="0" step="1000" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="price_weekend" name="price_weekend" class="form-input" 
                                   value="{{ old('price_weekend', $room->price_weekend) }}" min="0" step="1000" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="extra_bed_price" name="extra_bed_price" class="form-input" 
                                   value="{{ old('extra_bed_price', $room->extra_bed_price) }}" min="0" step="1000" required>
                        </div>

                        <div class="form-group">
                            <label for="max_guests" class="form-label">Max Guests</label>
                            <input type="number" id="max_guests" name="max_guests" class="form-input" 
                                   value="{{ old('max_guests', $room->max_guests) }}" min="1" max="10" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" id="image" name="image" class="form-input" 
                               value="{{ old('image', $room->image) }}" placeholder="https://example.com/image.jpg">
                    </div>
