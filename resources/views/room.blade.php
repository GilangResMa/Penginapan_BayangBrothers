        ...
        <div class="container">
                ...
                <div class="room-grid">
                    ...
                    <div class="room-info">
                        ...
                        <div class="description">
                            <p>{{ $room->description ?? 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.' }}</p>
                        </div>

                        <div class="price">
                            <div class="price-main">
                                <span class="price-label">Price: </span>
                                <span id="total-price-{{ $room->id }}" class="price-amount">Rp {{ number_format($room->price, 0, ',', '.') }}</span>
                            </div>
                            <div id="price-details-{{ $room->id }}" style="display: none;" class="price-details">
                    ...
                    <div class="booking-inputs">
                        <div class="input-group">
                            ...
                            <div class="date-inputs">
                                <input type="date" id="checkin_{{ $room->id }}" class="date-input" onchange="updatePriceDisplayForRoom({{ $room->id }})">
                                <span class="date-separator">-</span>
                                <input type="date" id="checkout_{{ $room->id }}" class="date-input" onchange="updatePriceDisplayForRoom({{ $room->id }})">
                            </div>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <select id="persons_{{ $room->id }}" class="select-input" onchange="updatePriceDisplayForRoom({{ $room->id }})">
                        ...
                        <div class="input-group">
                            ...
                            <button class="admin-button" onclick="window.open('https://wa.me/6281392640030', '_blank')">
                        ...
                        <div class="input-group">
                            @auth('web')
                                ...
                                <form method="POST" action="{{ route('room.book', $room->id) }}">
                                    ...
                                    <button type="submit" class="booking-btn" onclick="return setBookingData({{ $room->id }})">
            ...
            @empty
                <div class="empty-rooms">
                    ...
                    <p>Please check back later or <a href="tel:+6281392640030" class="contact-admin">contact us</a> for more information.</p>
                </div>
            @endforelse
        </div>
    </main>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            @foreach($rooms as $room)
                initializeRoomBookingForRoom({{ $room->id }}, {{ $room->price }});
            @endforeach
        });
