...
<body>
    <header class="header">
        <div class="header-container">
            ...
            <nav class="navigation">
                <span style="color: white;">Welcome, {{ Auth::user()->name ?? Auth::user()->email }}!</span>
    ...
    <main style="flex: 1; padding: 2rem; text-align: center;">
        <h1 style="font-size: 2rem; color: #1f2937; margin-bottom: 1rem;">User Dashboard</h1>
        <p style="color: #6b7280;">Welcome to your user dashboard!</p>
        <div style="margin-top: 2rem;">
            <a href="/room" style="background: #dc2626; color: white; padding: 0.75rem 1.5rem; border-radius: 0.5rem; text-decoration: none; display: inline-block;">
                View Rooms
            </a>
        </div>
    </main>
